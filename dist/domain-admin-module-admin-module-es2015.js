...
let WeatherForecastFavoriteComponent = class WeatherForecastFavoriteComponent {
    constructor(adminService, validationIconClass) {
        this.adminService = adminService;
...
let WeatherForecastSliderComponent = class WeatherForecastSliderComponent {
    ...
    validationIconInternal() {
        this.sixWeathers = this.sixWeathers && this.sixWeathers.map(value => (Object.assign({}, value, { iconFontawesome: this.validationIconClass.validationIcon(value).iconFontawesome })));
    }
};
