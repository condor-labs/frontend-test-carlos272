...
var WeatherForecastFavoriteComponent = /** @class */ (function () {
    ...
    WeatherForecastFavoriteComponent.prototype.ngOnInit = function () {
        ...
        this.headquartersOthers = this.headquartersOthers && this.headquartersOthers.map(function (value) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, value, { tempCelcius: _this.adminService.convertKelvinToCelcius(value.main.temp) })); });
    };
